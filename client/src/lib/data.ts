...
export const SITE_DATA = {
  ...
  reviews: [
    ...
    },
    {
      ...
      response: "Thank you! Looking forward to having you in the shop again. ✌️"
    },
    {
      id: 4,
      author: "Archie P",
      ...
      response: "Thank you Archie! Looking forward to seeing you again. 🤘🏼"
    },
    {
      id: 5,
      author: "Jonas",
      text: "Enjoyable new record store, it is noted if a record has surface noise or pops, owner is friendly and knowledgeable.",
      response: "Thank you Jonas! So kind. Looking forward to seeing you in the shop again! 🙏"
    },
    {
      id: 6,
      author: "sd Martin",
    ...
    },
    {
      ...
      response: "Thank you! Looking forward to seeing you in the shop again. 😊"
    }
  ],
  resources: [
    {
